...
//!
//! Every destination has a shortcut, and ⌘F searches sessions from anywhere.
//! Opening at login belongs to the app rather than to any page, so it sits in
//! the app's own submenu.
