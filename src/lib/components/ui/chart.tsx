...
export function ChartHoverCard({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      className={cn(
...
function ChartTooltipContent({
  ...
  const tooltipLabel = React.useMemo(() => {
    ...
    const [item] = payload;
    const key = String(labelKey ?? item?.name ?? item?.dataKey ?? "value");
  ...
  return (
    <ChartHoverCard className={className}>
