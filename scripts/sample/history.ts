    ...
    limits: [
      {
        ...
        perHour: 33,
        startsAt: now + 108 * MINUTE - 5 * HOUR,
      },
      {
        name: "Weekly",
        scope: null,
        ...
        runsOutAt: null,
        perHour: 0.6,
        startsAt: now + 3 * 24 * HOUR - 7 * 24 * HOUR,
      },
      {
        name: "Weekly",
        scope: "Opus",
    ...
    limits: [
      {
        ...
        runsOutAt: null,
        perHour: null,
        startsAt: now + 190 * MINUTE - 5 * HOUR,
      },
      {
        name: "Weekly",
        scope: null,
        ...
        runsOutAt: null,
        perHour: null,
        startsAt: now + 4 * 24 * HOUR - 7 * 24 * HOUR,
      },
      {
        name: "Weekly",
    ...
    limits: [
      {
        ...
        runsOutAt: null,
        perHour: null,
        // OpenCode Go's five hours roll, so they have no start.
        startsAt: null,
      },
      {
        name: "Weekly",
        ...
        runsOutAt: null,
        perHour: null,
        startsAt: now + 5 * 24 * HOUR - 7 * 24 * HOUR,
      },
      {
        name: "Monthly",
        scope: null,
        ...
        runsOutAt: null,
        perHour: null,
        startsAt: now + 16 * 24 * HOUR - 30 * 24 * HOUR,
      },
    ],
    readAt: now - 3 * MINUTE,
    problem: null,
  ...
  },
  {
    ...
    limits: [
      ...
      },
      {
        ...
        runsOutAt: null,
        perHour: null,
        startsAt: now + 6 * 24 * HOUR - 7 * 24 * HOUR,
      },
    ],
    readAt: now - 2 * MINUTE,
    problem: null,
    ...
    limits: [
      {
        ...
        runsOutAt: null,
        perHour: null,
        startsAt: now + 2 * 24 * HOUR - 7 * 24 * HOUR,
      },
    ],
