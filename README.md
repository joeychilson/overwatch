...
<img src=".github/assets/overwatch-menu-bar.png" alt="Overwatch menu bar panel showing what today has used, then the Claude and Codex accounts in use open with each limit's time to reset, how much is left, and a tick for how much of its window is left, and the OpenCode Go, Claude, and Grok accounts not in use on one line each" width="240" align="right">
